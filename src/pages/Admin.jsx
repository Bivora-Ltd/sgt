          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="grid grid-cols-12 gap-8">
                  ...
                  {tabs.map((tab) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center px-4 py-3 text-left hover:bg-gray-50 first:rounded-t-lg last:rounded-b-lg transition-colors ${activeTab === tab.id
              ...
              <div className="col-span-12 lg:col-span-9">
                        ...
                        {leaderboard
                          .map((contestant, index) => (
                            <div key={contestant._id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                              ...
                              <div className={`text-sm font-semibold ${contestant.status === 'evicted'
                                ? 'text-red-500'
                                : 'text-primary-500'
                ...
                {activeTab === 'payments' && (
                  <div className="space-y-6">
                    <h2 className="text-2xl font-bold text-gray-900">Payment History for Street's Got Talent {season?.title}</h2>
                    {/* history */}
                    <div className="bg-white rounded-lg shadow-md p-6">
                      {/* <h3 className="text-lg font-semibold text-gray-900 mb-4">Top Contestants</h3> */}
                      <div className="space-y-3">
                          ...
                          {['audition', 'group', 'semi', 'final'].map((stage, index, arr) => {
                            ...
                            return (
                              <div key={stage} className="flex-1 flex items-center">
                                <div className={`relative z-10 w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-semibold ${isActive ? 'bg-primary-600' :
                                ...
                                {index !== arr.length - 1 && (
                                  <div className={`flex-1 h-1 ${isCompleted ? 'bg-green-500' :
