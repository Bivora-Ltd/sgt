...
const RegistrationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const result = await registerContestant(fd); // ✅ properly declared
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            {formData.name}! Registration has been submitted successfully.
            contestant will receive a confirmation email shortly with next steps.
          </p>
